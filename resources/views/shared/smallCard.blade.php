...
<div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
    <img class="img-fluid" src="{{ $post->getPostImage() }}" alt="" width="110px">
    <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
        ...
        <a class="h6 m-0 text-secondary text-uppercase font-weight-bold" href="{{ route('blog.show', ['slug' => $post->slug, $post]) }}">{{Str::of($post->title)->limit(20)}}</a>
    </div>
</div>